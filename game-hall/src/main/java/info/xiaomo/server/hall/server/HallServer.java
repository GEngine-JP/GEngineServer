...
public class HallServer implements Runnable {
    ...
    public HallServer(String configPath) {
        ...
        if (hallClientThreatPool == null) {
            LOGGER.error("{}hallClientThreadPoolExecutorConfig.yml未找到", configPath);
            System.exit(0);
        }
        ...
        if (minaClientConfig_gate == null) {
            LOGGER.error("{}minaClientConfig_hall.yml未找到", configPath);
            System.exit(0);
        }
        ...
        if (minaServerConfig_http == null) {
            LOGGER.error("{}minaServerConfig_http.yml未找到", configPath);
            System.exit(0);
        }
