package info.xiaomo.server.fish.config.beans;
...
import info.xiaomo.server.fish.config.converters.IntegerArrayConverter;
import info.xiaomo.server.fish.config.converters.IntegerMapConverter;
import info.xiaomo.server.fish.config.converters.Matrix3IntConverter;
import lombok.Data;
