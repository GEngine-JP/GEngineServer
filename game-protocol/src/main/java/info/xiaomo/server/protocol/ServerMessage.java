...
public final class ServerMessage {
  ...
  public static final class ServerRegisterRequest extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ServerRegisterReq;
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ServerRegisterRequest.newBuilder()
      private Builder() {
      ...
      // optional .MID mid = 1 [default = ServerRegisterReq];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ServerRegisterReq;
      /**
       * <code>optional .MID mid = 1 [default = ServerRegisterReq];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ServerRegisterResponse extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ServerRegisterRes;
      serverInfo_ = ServerInfo.getDefaultInstance();
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ServerRegisterResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      // optional .MID mid = 1 [default = ServerRegisterRes];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ServerRegisterRes;
      /**
       * <code>optional .MID mid = 1 [default = ServerRegisterRes];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ServerListRequest extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ServerListReq;
      serverType_ = 0;
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ServerListRequest.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      // optional .MID mid = 1 [default = ServerListReq];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ServerListReq;
      /**
       * <code>optional .MID mid = 1 [default = ServerListReq];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ServerListResponse extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ServerListRes;
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ServerListResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      // optional .MID mid = 1 [default = ServerListRes];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ServerListRes;
      /**
       * <code>optional .MID mid = 1 [default = ServerListRes];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ChangeRoleServerRequest extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ChangeRoleServerReq;
      serverId_ = 0;
      serverType_ = 0;
      roleId_ = 0L;
    }
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ChangeRoleServerRequest.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      // optional .MID mid = 1 [default = ChangeRoleServerReq];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ChangeRoleServerReq;
      /**
       * <code>optional .MID mid = 1 [default = ChangeRoleServerReq];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ChangeRoleServerResponse extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ChangeRoleServerRes;
      result_ = 0;
    }
    private byte memoizedIsInitialized = -1;
    public final boolean isInitialized() {
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ChangeRoleServerResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      // optional .MID mid = 1 [default = ChangeRoleServerRes];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ChangeRoleServerRes;
      /**
       * <code>optional .MID mid = 1 [default = ChangeRoleServerRes];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ServerEventRequest extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ServerEventReq;
      type_ = 0;
      serverId_ = 0;
      id_ = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ServerEventRequest.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      // optional .MID mid = 1 [default = ServerEventReq];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ServerEventReq;
      /**
       * <code>optional .MID mid = 1 [default = ServerEventReq];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ServerEventResponse extends
    ...
    private void initFields() {
      mid_ = info.xiaomo.server.protocol.Mid.MID.ServerEventRes;
      type_ = 0;
      result_ = 0;
    }
    private byte memoizedIsInitialized = -1;
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ServerEventResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      // optional .MID mid = 1 [default = ServerEventRes];
      private info.xiaomo.server.protocol.Mid.MID mid_ = info.xiaomo.server.protocol.Mid.MID.ServerEventRes;
      /**
       * <code>optional .MID mid = 1 [default = ServerEventRes];</code>
       */
      public boolean hasMid() {
  ...
  public static final class ServerInfo extends
    ...
    public static final class Builder extends
      ...
      // Construct using info.xiaomo.server.protocol.ServerMessage.ServerInfo.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
